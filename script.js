...
let daynight = document.getElementsByClassName('day-night')[0]
let indicator = document.getElementsByClassName('indicator')[0]
let body = document.querySelector('body')
let container = document.getElementsByClassName("container")[0]
let time = document.getElementsByClassName('time')[0]
let statusl = document.getElementsByClassName('status')[0]
let lmode = document.getElementsByClassName('lmode')[0]
...
daynight.onclick = ()=>{
 indicator.classList.toggle('night')
  ...
  currenttime.classList.toggle('ctime-dark')
  circle.classList.toggle('circle-dark')
  time.classList.toggle('time-dark')
  statusl.classList.toggle('status-dark')
  daynight.classList.toggle('daynight-dark')
  lmode.classList.toggle('lmode-dark')
  dmode.classList.toggle('dmode-dark')
